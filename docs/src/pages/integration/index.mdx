...
<strong>Updated 11/11/2020</strong> - Work in progress
</InlineNotification>
...
Some values, in particular numbers, are the same on in the ODM world and in the WML world. In this case the initializations of the scoring parameters can be simply done with a rule like the following:
